    ...
    <React.Fragment>
      <div className="container dashboard">
        ...
        <div className="information">
          ...
          <Card titulo="Orden de Pedidos Pendientes" numero="5" color="#94744C" />

          <Card titulo="Orden de Pedidos En Proceso" numero="5" color="#6d949c" />

          <Card titulo="Orden de Pedidos Entregados" numero="5" color="#94744C" />
          ...
          <Card titulo="Empresas" numero="50" color="#94744C" />
        </div>
