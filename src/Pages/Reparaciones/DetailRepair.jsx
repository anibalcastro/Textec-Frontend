...
const RepairDetail = () => {
    ...
    const validateRole = (role) => {
        if (role === "Admin" && order && order.estado && order.estado !== "Anulada") {
            return true;
        }
    ...
    return (
        <React.Fragment>
            ...
            <Detail order={order} detail={detail} invoice={invoice} company={company}
                product={product} title="Reparación" subtitle={"Detalle"}/>
            ...
            <div className="container botones-contenedor">
                ...
                {order && order.estado && collaboratorPermissions && order.estado !== "Entregado" && (
